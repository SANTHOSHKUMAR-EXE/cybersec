  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <header className="bg-blue-600 text-white py-8 px-4 text-center">
        <h1 className="text-4xl font-bold mb-2">Cybersecurity Awareness Training Program</h1>
        <p className="text-xl">Your guide to protecting your organization and yourself from cyber threats.</p>
      </header>
      ...
      <div className="container mx-auto px-4 py-8">
        <Section id="intro" title="What is Cybersecurity?">
          <p><strong>Cybersecurity</strong> refers to the practice of protecting systems, networks, and data from digital attacks. In today's connected world, businesses and individuals are increasingly vulnerable to hackers, who aim to steal sensitive information, disrupt operations, or damage reputations.</p>
        </Section>

        <Section id="need" title="Why You Need to Be Aware">
          <p>Cybersecurity is no longer just an IT issue; it's everyone's responsibility. Whether you're an employee, manager, or executive, being aware of cyber threats helps prevent data breaches, phishing scams, and social engineering attacks. Employees are often the first line of defense, and human error is one of the leading causes of successful attacks.</p>
        </Section>

        <Section id="common-crimes" title="Common Cyber Crimes Employees Face">
        ...
        <Section id="scams" title="Popular Scams Targeting Employees">
        ...
        <Section id="awareness" title="Employee Awareness & Best Practices">
        ...
        <Section id="attacks" title="Types of Cyber Attacks">
      ...
      <footer className="bg-blue-600 text-white py-4 text-center">
        <p>&copy; 2024 Cybersecurity Awareness Training Program</p>
      </footer>
    </div>
  );
};
